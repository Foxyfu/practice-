...
namespace Task1
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["Test"].ConnectionString))
            {
                ...
                if (sqlConnection.State == System.Data.ConnectionState.Open)
                {
                    ...
                    await PrintCommand(getAllTourists);
                    ...
                    Console.WriteLine("Добавляем туриста Максима...\n");
                    await PrintCommand(getAllTourists);
                    ...
                    Console.WriteLine("Турист изменён...\n");
                    await PrintCommand(getAllTourists);
                }
            }
        ...
        public static async Task PrintCommand(SqlCommand command)
        {
